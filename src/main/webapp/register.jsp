        ...
        <table>
            ...
            <tr style="font-size: large; font-weight: bold">
                ...
                <td><input type="text" id="lname" name="lname" value=""
                           size="20"/></td>
                <td style="font-size: small; font-weight: normal; color:blue">
                    <%
                        if (errorname != null) {
            ...
            <tr style="font-size: large; font-weight: bold">
                ...
                <td>Male<input type="radio" name="gender" value="M"/>
                    ...
                    <!-- <input type="hidden" id="gender" name="gender" value="empty"/> -->
                </td>
            </tr>
            <tr style="font-size: large; font-weight: bold">
                <td>Qualification</td>
                <td>SPM<input type="checkbox" name="qualification"
                    ...
                    <!-- <input type="hidden" id="qualification" name="qualification" value="empty"/> -->
                </td>
            </tr>
            <tr style="font-size: large; font-weight: bold">
                <td>Race</td>
