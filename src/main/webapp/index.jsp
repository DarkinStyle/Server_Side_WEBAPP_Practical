    ...
    <div id="header">
        <div>
            ...
            <ul id="navigation">
                ...
                <li class="menu">
                    <a href="AptitudeTest.jsp">Aptitude Test</a>
                    <ul class="primary">
                        <li>
                ...
                <li class="menu">
                    <%
                        ...
                        c.setMaxAge(-1); // two types - session cookie and persistence cookie, -1 value is session cookie
        ...
        <form action="Search">
            <input type="submit" value="Search On Jobs " />
